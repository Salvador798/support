!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t =
        "undefined" != typeof globalThis ? globalThis : t || self).salvador =
        e());
})(this, function () {
  "use strict";
  const t = new Map(),
    e = {
      set(e, i, n) {
        ...
        s.has(i) || 0 === s.size
          ? s.set(i, n)
          : console.error(
              `No se permite más de un elemento: ${Array.from(s.keys())[0]}.`
            );
      },
  ...
  class H {
    ...
    static get NAME() {
      throw new Error('Implementa el método estático", para cada componente');
    }
    _getConfig(t) {
      return (
  ...
  class qi extends W {
    ...
    _createPopper() {
      if (void 0 === vi)
        throw new TypeError(
          "salvador' los menús desplegables requieren Popper (https://popper.js.org)"
        );
      let t = this._element;
  ...
  class cs extends W {
    constructor(t, e) {
      if (void 0 === vi)
        throw new TypeError(
          "salvador's tooltips require Popper (https://popper.js.org)"
        );
      super(t, e),
        (this._isEnabled = !0),
        (this._timeout = 0),
...
//# sourceMappingURL=salvador.bundle.min.js.map
